...
class BaseResponse<T> {
  ...
  static T _dataFromJson<T>(Object json) {
    if (json is Map<String, dynamic>) {
      if (json.containsKey('email')) return User.fromJson(json) as T;
      if (json.containsKey('title')) return Article.fromJson(json) as T;
    } else if (json is List) {
      return json.map((e) => Article.fromJson(e as Map<String, dynamic>)).toList() as T;
    }
